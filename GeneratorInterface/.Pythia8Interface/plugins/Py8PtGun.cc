...
bool Py8PtGun::generatePartonsAndHadronize()
{
   ...
   for ( size_t i=0; i<fPartIDs.size(); i++ ){
      ...
      // MODIFIED: Hardcoded to force a flat pT distribution between 10.0 and 100.0 GeV
      double pt   = (100.0 - 10.0) * randomEngine().flat() + 10.0;
      
      // MODIFIED: Hardcoded to force a flat mass distribution between 0.1 and 10.0 GeV
      double mass = (10.0 - 0.1) * randomEngine().flat() + 0.1;
